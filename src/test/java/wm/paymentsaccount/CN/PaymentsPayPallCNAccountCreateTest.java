...
public class PaymentsPayPallCNAccountCreateTest extends BaseTest {
    ...
    @Test
    @Title("Создание кошелька paypall, Страна Китай, Юрисдикция onshore, Тип контрагента  Физ-лицо")
    ...
    @Test
    @Title("Создание кошелька paypall, Страна Китай, Юрисдикция onshore, Тип контрагента Юридическое лицо")
    @Stories("создание кошелька paypall")
    @Severity(value = SeverityLevel.CRITICAL)
    ...
    @Test
    @Title("Создание кошелька paypall, Страна Китай, Юрисдикция onshore, Тип контрагента  Индивидуальный предприниматель")
    @Stories("создание кошелька paypall")
    @Severity(value = SeverityLevel.CRITICAL)
    public void PaymentsAccountOnshoreIPPaypallCreateTest() throws InterruptedException {
        office.goTopaymentsInfo();
        paypage.clickCreate();
        paypage.fill1stStep();
        paypage.fill2stStepCN();
    ...
    @Test
    @Title("Создание кошелька paypall, Страна Китай, Юрисдикция OFFshore, Тип контрагента  Индивидуальный предприниматель")
    @Stories("создание кошелька paypall")
    @Severity(value = SeverityLevel.CRITICAL)
    public void PaymentsAccountOFFshoreIPPaypallCreateTest() throws InterruptedException {
        office.goTopaymentsInfo();
        paypage.clickCreate();
        paypage.fill1stStep();
        paypage.fill2stStepCN();
    ...
    @Test
    @Title("Создание кошелька paypall, Страна Китай, Юрисдикция OFFshore, Тип контрагента  Юридическое лицо")
    @Stories("создание кошелька paypall")
    @Severity(value = SeverityLevel.CRITICAL)
    ...
    @Test
    @Title("Создание кошелька paypall, Страна Китай, Юрисдикция OFFshore, Тип контрагента Физическое лицо")
    @Stories("создание кошелька paypall")
    @Severity(value = SeverityLevel.CRITICAL)
