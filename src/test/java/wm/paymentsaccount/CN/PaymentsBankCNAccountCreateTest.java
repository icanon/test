...
public class PaymentsBankCNAccountCreateTest extends BaseTest {
    ...
    @Test
    @Title("Создание кошелька банка, Страна Китай, Юрисдикция onshore, Тип контрагента  Физ-лицо")
    ...
    @Test
    @Title("Создание кошелька банка, Страна Китай, Юрисдикция onshore, Тип контрагента Юридическое лицо")
    @Stories("создание кошелька банка")
    @Severity(value = SeverityLevel.CRITICAL)
    public void PaymentsAccountOnshoreULBankCreateTest() throws InterruptedException {
        ...
        paypage.fill4stStepBank();
        paypage.fill5stStepCN(1);
        paypage.checkInputsPayments(14);
        paypage.fill6and7stStepBankautocomplitCNwithotUpload();
        paypage.savePaymentsInfo();
        paypage.fillverificationform();
    }
    ...
    @Test
    @Title("Создание кошелька банка, Страна Китай, Юрисдикция onshore, Тип контрагента  Индивидуальный предприниматель")
    @Stories("создание кошелька банка")
    @Severity(value = SeverityLevel.CRITICAL)
    ...
    @Test
    @Title("Создание кошелька банка, Страна Китай, Юрисдикция OFFshore, Тип контрагента  Индивидуальный предприниматель")
    @Stories("создание кошелька банка")
    @Severity(value = SeverityLevel.CRITICAL)
    public void PaymentsAccountOFFshoreIPBankCreateTest() throws InterruptedException {
        ...
        paypage.check4stStepLabels(2);
        paypage.fill4stStepBank();
        paypage.fill5stStepCN(7);
        paypage.checkInputsPayments(11);
        paypage.fill6and7stStepBankautocomplitCNwithotUploadswift();
        paypage.savePaymentsInfo();
        paypage.fillverificationform();
    }

    @Test
    @Title("Создание кошелька банка, Страна Китай, Юрисдикция OFFshore, Тип контрагента  Юридическое лицо")
    @Stories("создание кошелька банка")
    @Severity(value = SeverityLevel.CRITICAL)
    ...
    @Test
    @Title("Создание кошелька банка, Страна Китай, Юрисдикция OFFshore, Тип контрагента Физическое лицо")
    @Stories("создание кошелька банка")
    @Severity(value = SeverityLevel.CRITICAL)
    public void PaymentsAccountOFFshoreFIZBankCreateTest() throws InterruptedException {
        ...
        paypage.fill4stStepBank();
        paypage.fill5stStepCN(7);
        paypage.checkInputsPayments(10);
        paypage.fill6and7stStepBankautocomplitCNwithotUploadswift();
        paypage.savePaymentsInfo();
        paypage.fillverificationform();
    }
