...
public class PaymentsBankBRLAccountCreateTest extends BaseTest {
    ...
    @Test
    @Title("Создание кошелька банка, Страна Бразилия, Юрисдикция onshore, Тип контрагента  Физ-лицо")
    ...
    public void PaymentsAccountOnshoreFizBankCreateTest() throws InterruptedException {
        ...
        paypage.checkInputsPayments(6);
        paypage.fill6and7stStepBankautocomplit();
    ...
    @Test
    @Title("Создание кошелька банка, Страна Бразилия, Юрисдикция onshore, Тип контрагента Юридическое лицо")
    @Stories("создание кошелька банка")
    @Severity(value = SeverityLevel.CRITICAL)
    ...
    @Test
    @Title("Создание кошелька банка, Страна Бразилия, Юрисдикция OFFshore, Тип контрагента  Юридическое лицо")
    @Stories("создание кошелька банка")
    @Severity(value = SeverityLevel.CRITICAL)
    public void PaymentsAccountOFFshoreURBankCreateTest() throws InterruptedException {
        ...
        paypage.fill6and7stStepBankautocomplitoffshore();
        paypage.savePaymentsInfo();
        paypage.fillverificationform();
    }

    @Test
    @Title("Создание кошелька банка, Страна Бразилия, Юрисдикция OFFshore, Тип контрагента Физическое лицо")
    @Stories("создание кошелька банка")
    @Severity(value = SeverityLevel.CRITICAL)
