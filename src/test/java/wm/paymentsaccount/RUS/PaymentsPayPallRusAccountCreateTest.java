...
public class PaymentsPayPallRusAccountCreateTest extends BaseTest {
    ...
    @Test
    @Title("Создание кошелька paypall, Страна Россия, Юрисдикция onshore, Тип контрагента  Физ-лицо")
    ...
    @Test
    @Title("Создание кошелька paypall, Страна Россия, Юрисдикция onshore, Тип контрагента Юридическое лицо")
    @Stories("создание кошелька paypall")
    @Severity(value = SeverityLevel.CRITICAL)
    ...
    @Test
    @Title("Создание кошелька paypall, Страна Россия, Юрисдикция onshore, Тип контрагента  Индивидуальный предприниматель")
    @Stories("создание кошелька paypall")
    @Severity(value = SeverityLevel.CRITICAL)
    ...
    @Test
    @Title("Создание кошелька paypall, Страна Россия, Юрисдикция OFFshore, Тип контрагента  Индивидуальный предприниматель")
    @Stories("создание кошелька paypall")
    @Severity(value = SeverityLevel.CRITICAL)
    ...
    @Test
    @Title("Создание кошелька paypall, Страна Россия, Юрисдикция OFFshore, Тип контрагента  Юридическое лицо")
    @Stories("создание кошелька paypall")
    @Severity(value = SeverityLevel.CRITICAL)
    ...
    @Test
    @Title("Создание кошелька paypall, Страна Россия, Юрисдикция OFFshore, Тип контрагента Физическое лицо")
    @Stories("создание кошелька paypall")
    @Severity(value = SeverityLevel.CRITICAL)
