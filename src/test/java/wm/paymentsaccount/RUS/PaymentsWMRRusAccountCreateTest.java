...
@Test
@Features("Создание счета wmr")
public class PaymentsWMRRusAccountCreateTest extends BaseTest {
    ...
    @Test
    @Title("Создание кошелька wmr, Страна Россия, Юрисдикция onshore, Тип контрагента  Физ-лицо")
    @Stories("создание кошелька wmr")
    @Severity(value = SeverityLevel.CRITICAL)
    public void PaymentsAccountOnshoreFizwmrCreateTest() throws InterruptedException {
    ...
    @Test
    @Title("Создание кошелька wmr, Страна Россия, Юрисдикция OFFshore, Тип контрагента Физическое лицо")
    @Stories("создание кошелька wmr")
    @Severity(value = SeverityLevel.CRITICAL)
    public void PaymentsAccountOFFshoreFIZwmrCreateTest() throws InterruptedException {
        office.goTopaymentsInfo();
        paypage.clickCreate();
        paypage.fill1stStep();
        paypage.fill2stStepRU();
