...
public class FinancePayoutCurrencyFilterTest extends BaseTest {
    ...
    @Test
    @Stories("проверка фильтрации выплат по валюте в вкладке финансы")
    @Severity(value = SeverityLevel.NORMAL)
    public void curencyTopFilterTest() throws InterruptedException {

        String chosencurrency = finance.chooseTopCurrency(6);
        finance.checkPayoutInTableContainsChosenCurrency(chosencurrency);
